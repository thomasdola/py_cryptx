defmodule PyCryptX.Port do
    ...
    def start_link() do
        python_dir = :code.priv_dir(:py_cryptx) ++ '/python/'
        PyCryptX.Port.start_link([path: "#{python_dir}", python: "python"], [name: @worker_name])
    end
    ...
    def get_path(), do: :code.priv_dir(:py_cryptx) ++ '/python/'
end